<?php
/**
 * CategoryValuationFixture
 *
 */
class CategoryValuationFixture extends CakeTestFixture {
 ...
 * @var string
 */
	public $table = 'category_valuation';
 ...
 */
	public $fields = array(
		'cv_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'cv_id', 'unique' => 1)
		),
